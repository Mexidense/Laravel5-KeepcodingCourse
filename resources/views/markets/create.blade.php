                    ...
                    <div class="card-body">
                        ...
                        <form class='form-horizontal' action="{{ route('market.create') }}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="name" id="market-name" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="description" class="col-md-4 form-control-label">Descripción</label>
                                <div class="col-md-6">
                                    <input type="text" name="description" id="market-description" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6 offset-md-4">
                                    <div class="checkbox">
                                        <label for="active" class="">
                                            <input type="checkbox" value="1" name="active" id="market-active"> Activo
                                        </label>
                                    </div>
                                </div>
                            </div>
